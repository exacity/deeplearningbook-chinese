...
如\secref{sec:batch_and_minibatch_algorithms}讨论，通过计算独立同分布地从\gls{DGD}中抽取的$m$个\gls{minibatch}样本的梯度均值，我们可以得到梯度的\gls{unbiased}估计。
% 286 mid
...
\gls{momentum}方法\citep{polyak1964some}旨在加速学习，特别是处理高曲率，小但一致的梯度，或是带\gls{noise}的梯度。
