...
\firstgls{dbd}算法\citep{jacobs1988}是一个早期的在训练时适应模型参数各自\gls{learning_rate}的启发式方法。
...
对于非二次的表面，只要\gls{hessian}保持正定，\gls{newton_method}能够迭代地应用。
这意味着一个两步迭代过程。
