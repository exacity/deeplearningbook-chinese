...
减少推断所需要的开销中一个关键的策略是\firstgls{model_compression}\citep{bucilua2006model}。
...
在这种情况下，使用\gls{gater}不会减少计算成本，但如果每个样本的\gls{gater}选择单个专家，我们获得一个特殊的\firstgls{hard_mixture_of_experts}~\citep{collobert:2001:rr01-12,collobert:2002}，这可以加速推断和训练的时间。
