...
% -- 602 end
\cite{Perpinan+Hinton-2005-small}从实验上证明对于\glssymbol{RBM}和完全可见的\gls{BM}来说，\,\glssymbol{contrastive_divergence}\,\gls{estimator}是\gls{biased}的，因为它会收敛到与\gls{MLE}不同的点。
